            ...
            <div className='col-md-4 mb-4' key={index} >
              <div className='card h-100 d-flex flex-column'>
                ...
                <div className='card-body'>
                  ...
                  <h6 className='card-title'><strong>Status: </strong>{character.status}</h6>
                  <h6 className='card-title'><strong>Species: </strong>{character.species}</h6>
                  <h6 className='card-title'><strong>Gender: </strong>{character.gender}</h6>
                  <h6 className='card-title'><strong>Origin: </strong>{character.origin.name}</h6>
                </div>
              </div>
            </div>
